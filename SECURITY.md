...
This is a generated TypeScript SDK for Warp API, produced by the Scalar SDK Generator (https://scalar.com).
...
If the issue is in the Warp API or service rather than in this SDK, report it through the security process Warp API has published.
