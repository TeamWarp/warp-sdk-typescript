...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ id: string; createdAt: string; endAt: string; endRangeType: 'date' | 'datetime'; reason: string; requestedMinutes: number; startAt: string; startRangeType: 'date' | 'datetime'; status: 'pending' | 'approved' | 'denied'; timeOffPolicyId: string; timeZone: string; workerId: string; }",
    markdown:
      "## list_requests\n\n`client.timeOff.listRequests(afterId?: string, beforeId?: string, endsBefore?: string, endsOnOrAfter?: string, limit?: string, policyIds?: string[], startsBefore?: string, startsOnOrAfter?: string, statuses?: 'pending' | 'approved' | 'denied'[], workerIds?: string[]): { id: string; createdAt: string; endAt: string; endRangeType: 'date' | 'datetime'; reason: string; requestedMinutes: number; startAt: string; startRangeType: 'date' | 'datetime'; status: 'pending' | 'approved' | 'denied'; timeOffPolicyId: string; timeZone: string; workerId: string; }`\n\n**get** `/v1/time_off/requests`\n\nGet the time off requests that workers in your company have made.\n\n### Parameters\n\n- `afterId?: string`\n\n- `beforeId?: string`\n\n- `endsBefore?: string`\n  a string to be decoded into a Date\n\n- `endsOnOrAfter?: string`\n  a string to be decoded into a Date\n\n- `limit?: string`\n  a number less than or equal to 100\n\n- `policyIds?: string[]`\n\n- `startsBefore?: string`\n  a string to be decoded into a Date\n\n- `startsOnOrAfter?: string`\n  a string to be decoded into a Date\n\n- `statuses?: 'pending' | 'approved' | 'denied'[]`\n\n- `workerIds?: string[]`\n\n### Returns\n\n- `{ id: string; createdAt: string; endAt: string; endRangeType: 'date' | 'datetime'; reason: string; requestedMinutes: number; startAt: string; startRangeType: 'date' | 'datetime'; status: 'pending' | 'approved' | 'denied'; timeOffPolicyId: string; timeZone: string; workerId: string; }`\n\n  - `id: string`\n  - `createdAt: string`\n  - `endAt: string`\n  - `endRangeType: 'date' | 'datetime'`\n  - `reason: string`\n  - `requestedMinutes: number`\n  - `startAt: string`\n  - `startRangeType: 'date' | 'datetime'`\n  - `status: 'pending' | 'approved' | 'denied'`\n  - `timeOffPolicyId: string`\n  - `timeZone: string`\n  - `workerId: string`\n\n### Example\n\n```typescript\nimport Warp from 'warp-hr';\n\nconst client = new Warp();\n\n// Automatically fetches more pages as needed.\nfor await (const timeOffListRequestsResponse of client.timeOff.listRequests()) {\n  console.log(timeOffListRequestsResponse);\n}\n```",
    perLanguage: {
      typescript: {
